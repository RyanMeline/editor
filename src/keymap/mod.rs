    ...
    match event {
        Event::Key(event) => {
            ...
            match event.code {
                ...
                KeyCode::Char(c) => return Action::InsertChar(c),
                KeyCode::Enter => return Action::InsertNewLine,
                KeyCode::Backspace => return Action::DeleteCharBack,
                KeyCode::Delete => return Action::DeleteCharForward,
                KeyCode::Down => return Action::MoveCursor(Direction::Down),
                KeyCode::Up => return Action::MoveCursor(Direction::Up),
                KeyCode::Left => return Action::MoveCursor(Direction::Left),
                KeyCode::Right => return Action::MoveCursor(Direction::Right),
                _ => {}
            }
        }
        // Event::Paste(str) => {}
